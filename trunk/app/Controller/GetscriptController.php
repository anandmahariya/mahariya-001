        ...
        if($tmp != ''){
            ...
            if(isset($data[1][3]) && !empty($data[1][3])){
                ...
                if(count($tmp) == 7){
                    ...
                    $this->comments .= sprintf('Get Origin data column not equal to 7');
                    return false;
                }
            }else{
                $this->comments .= sprintf('Get Origin date[1][1] not found');
                return false;
            }
        }else{
            if($loop > 3){
                $this->comments .= sprintf('Get Origin AS request exceed 3 ip %s : ',$ip);
                return false;
            }else{
