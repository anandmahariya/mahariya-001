<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            <!-- form start -->
            <?php echo $this->Form->create('search', array('url' => array('controller' => 'settings', 'action' => 'blockip'))); ?>
                <div class="box-body">
                    <div class="row">
                        <div class="form-group col-lg-4">
                            <?php echo $this->Form->input('ip',array('class'=>'form-control','placeholder'=>'IP Address','label'=>__('IP Address'))); ?>
                        </div>
                    </div>
                </div><!-- /.box-body -->
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <?php echo $this->Html->link('Add New Range',array('controller'=>'settings','action'=>'blockipopr'),array('class'=>'btn btn-success btn-sm')); ?>
                    </div>
                </div>
                ...
                <table id="example1" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo $this->Paginator->sort('start','Start Range'); ?></th>
                            <th><?php echo $this->Paginator->sort('end','End Range'); ?></th>
                            <th width="22%">&nbsp;</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                            ...
                            foreach($data as $key=>$val){
                                $delete = _encode(array('id'=>$val['Blockip']['id'],'opr'=>'delete'));
                        ?>
                        <tr>
                            <td><?php echo $val['Blockip']['name']; ?></td>
                            <td><?php echo long2ip($val['Blockip']['start']); ?></td>
                            <td><?php echo long2ip($val['Blockip']['end']); ?></td>
                            <td>
                                <?php
                                    echo $this->Html->link('Delete',array('controller'=>'settings','action'=>'blockipopr','?'=>array('action'=>$delete)),array('class'=>'btn btn-danger btn-sm confirm','message'=>'Are you sure to delete'));
                                ?>
                            </td>
                        </tr>
                        <?php }} else { ?>
